...
class Bird(pygame.sprite.Sprite):
    ...
    def image(self):
        ...
        """
        if pygame.time.get_ticks() % 550 >= 250:
    ...
    def mask(self):
        ...
        if pygame.time.get_ticks() % 10 >= 50:
...
def load_images():
    ...
    def load_image(img_file_name):
        ...
        file_name = os.path.join(os.path.dirname(__file__), 'images',
                                 img_file_name)
...
def main():
    ...
    bird = Bird(50, int(WIN_HEIGHT / 2 - Bird.HEIGHT / 1), 1,
    ...
    while not done:
        ...
        for e in pygame.event.get():
            if e.type == QUIT or (e.type == KEYUP and e.key == K_ESCAPE):
                ...
                break
            elif e.type == KEYUP and e.key in (K_PAUSE, K_m):
                paused = not paused
